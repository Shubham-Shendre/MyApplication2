...
public class MainActivity extends AppCompatActivity {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ListViewAdapter adapter = new ListViewAdapter(facultyList, getApplicationContext());
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view,
                                    ...
                                    //this method will fetch and parse the data
                                    loadHeroineList("https://www.nagpurstudents.org/api/others/api.php?apicall=" + query1,facultysend);
                                }
    ...
    private void loadHeroineList(String URL, final String facultysend) {
                            ...
                            listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view,
                                   ...
                                   if ( faculty.equalsIgnoreCase("btech") )
                                   {
                                    ...
                                    System.out.println("\n semlist" + semList);
                                    loadVillanList(JSON_URL2,semList);
                                }
                            });
                        } catch (JSONException e) {
                            e.printStackTrace();
    ...
    private void loadVillanList(String url, final List<Integer> sem) {
        ...
        final ArrayAdapter<Integer> adapter = new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, sem);
        listView.setAdapter(adapter);
